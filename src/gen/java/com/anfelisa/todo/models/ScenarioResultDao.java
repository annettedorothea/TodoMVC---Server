...
public class ScenarioResultDao {
	...
	public Integer insert(Handle handle, IScenarioResultModel scenarioResultModel) {
		Query<Map<String, Object>> statement = handle.createQuery("INSERT INTO public.scenarioresult (scenarioid, description, timeline, executor, createddatetime, serverversion, clientversion, device) VALUES (:scenarioid, :description, :timeline, :executor, :createddatetime, :serverversion, :clientversion, :device) RETURNING id");
	...
	public void updateById(Handle handle, IScenarioResultModel scenarioResultModel) {
		Update statement = handle.createStatement("UPDATE public.scenarioresult SET scenarioid = :scenarioid, description = :description, timeline = :timeline, executor = :executor, createddatetime = :createddatetime, serverversion = :serverversion, clientversion = :clientversion, device = :device WHERE id = :id");
		statement.bind("scenarioid",  scenarioResultModel.getScenarioId() );
		statement.bind("description",  scenarioResultModel.getDescription() );
		statement.bind("timeline",  scenarioResultModel.getTimeline() );
		statement.bind("executor",  scenarioResultModel.getExecutor() );
