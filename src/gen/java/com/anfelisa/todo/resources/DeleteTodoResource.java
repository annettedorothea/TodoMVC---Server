...
public class DeleteTodoResource extends Resource {
	...
	public Response deleteTodoResource(
		...
		try {
			com.anfelisa.todo.data.ITodoIdData data = new TodoIdData(uuid);
			data.setId(id);
			
			com.anfelisa.todo.actions.DeleteTodoAction action = new com.anfelisa.todo.actions.DeleteTodoAction(persistenceConnection, appConfiguration, daoProvider, viewProvider);
			...
			return unauthorized("authorization needed for /todos/delete");
		} catch (Exception x) {
