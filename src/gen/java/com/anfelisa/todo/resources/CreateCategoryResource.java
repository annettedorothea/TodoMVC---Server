...
public class CreateCategoryResource extends Resource {
	...
	public Response createCategoryResource(
		...
		try {
			com.anfelisa.todo.data.ICategoryData actionData = new CategoryData(uuid);
			actionData.setCategoryId(payload.getCategoryId());
			
			com.anfelisa.todo.actions.CreateCategoryAction action = new com.anfelisa.todo.actions.CreateCategoryAction(persistenceConnection, appConfiguration, daoProvider, viewProvider);
