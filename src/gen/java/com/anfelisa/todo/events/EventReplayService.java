	...
	public static void replayEvent(String eventClass, String json, PersistenceHandle handle, IDaoProvider daoProvider, ViewProvider viewProvider, CustomAppConfiguration appConfiguration) {
		try {
			if (eventClass.equals("com.anfelisa.todo.events.CreateTodoSuccessEvent")) {
				...
				Event event = new Event<TodoData>("com.anfelisa.todo.events.CreateTodoSuccessEvent", daoProvider, viewProvider, appConfiguration);
			...
			if (eventClass.equals("com.anfelisa.todo.events.CreateCategorySuccessEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<CategoryData>("com.anfelisa.todo.events.CreateCategorySuccessEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.todo.events.ToggleTodoSuccessEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<TodoToggleData>("com.anfelisa.todo.events.ToggleTodoSuccessEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.todo.events.ToggleAllSuccessEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<ToggleAllData>("com.anfelisa.todo.events.ToggleAllSuccessEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.todo.events.UpdateTodoSuccessEvent")) {
				TodoData data = mapper.readValue(json, TodoData.class);
				data.migrateLegacyData(json);
				Event event = new Event<TodoData>("com.anfelisa.todo.events.UpdateTodoSuccessEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.todo.events.DeleteTodoSuccessEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<TodoIdData>("com.anfelisa.todo.events.DeleteTodoSuccessEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.todo.events.ClearDoneSuccessEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<ClearDoneData>("com.anfelisa.todo.events.ClearDoneSuccessEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
		} catch (IOException e) {
