...
public abstract class AbstractToggleAllWhenOneIsDoneExpectAllToBeDoneScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractToggleAllWhenOneIsDoneExpectAllToBeDoneScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("ToggleTodo")) {
			...
			this.httpPut(
				"/todos/toggle?id=" + (data_3.getId() != null ? URLEncoder.encode(data_3.getId(), StandardCharsets.UTF_8.toString()) : "") + "", 
			 	null,
				null,
				uuid,
				null
			...
			if (response_3.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ToggleTodo fails due to {} in {} ms", message, response_3.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ToggleTodo success in {} ms", response_3.getDuration());
			addToMetrics("ToggleTodo", response_3.getDuration());
		} else {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		this.httpPut(
			"/todos/toggle-all?categoryId=" + (data_0.getCategoryId() != null ? URLEncoder.encode(data_0.getCategoryId(), StandardCharsets.UTF_8.toString()) : "") + "", 
		 	null,
			null,
			uuid,
			null
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ToggleAllWhenOneIsDoneExpectAllToBeDone")) {
			...
			LOG.info("WHEN: prerequisite for ToggleAllWhenOneIsDoneExpectAllToBeDone not met");
		}
	...
	protected String scenarioName() {
		return "ToggleAllWhenOneIsDoneExpectAllToBeDone";
	}
