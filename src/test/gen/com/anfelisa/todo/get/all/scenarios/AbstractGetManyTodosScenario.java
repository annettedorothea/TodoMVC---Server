...
public abstract class AbstractGetManyTodosScenario extends BaseScenario {
	...
	private HttpResponse<com.anfelisa.todo.data.GetAllTodosResponse> when_0() throws Exception {
		...
		this.httpGet(
			"/todos/all?categoryId=" + (data_0.getCategoryId() != null ? URLEncoder.encode(data_0.getCategoryId(), StandardCharsets.UTF_8.toString()) : "") + "", 
			null,
			uuid,
	...
	private com.anfelisa.todo.data.GetAllTodosResponse then_0(HttpResponse<com.anfelisa.todo.data.GetAllTodosResponse> response) throws Exception {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetManyTodos")) {
				...
				HttpResponse<com.anfelisa.todo.data.GetAllTodosResponse> response_0 = when_0();
				com.anfelisa.todo.data.GetAllTodosResponse actualResponse_0 = then_0(response_0);
				atLeastTwentyReturned(actualResponse_0);
